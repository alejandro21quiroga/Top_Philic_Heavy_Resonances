...
Decay_eta = Decay(name = 'Decay_eta',
                  particle = P.eta,
                  partial_widths = {(P.g,P.g):'(2*kg**2*Meta**6)/(cmath.pi*abs(Meta)**3)',
                                    (P.t,P.t__tilde__):'(3*kt**2*Meta**2*cmath.sqrt(Meta**4 - 4*Meta**2*MT**2))/(8.*cmath.pi*abs(Meta)**3)'})

Decay_H = Decay(name = 'Decay_H',
                particle = P.H,
                partial_widths = {(P.c,P.c__tilde__):'((-12*MC**2*yc**2 + 3*MH**2*yc**2)*cmath.sqrt(-4*MC**2*MH**2 + MH**4))/(16.*cmath.pi*abs(MH)**3)',
