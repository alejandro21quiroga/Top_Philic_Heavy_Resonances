...
Decay_sig1 = Decay(name = 'Decay_sig1',
                   particle = P.sig1,
                   partial_widths = {(P.t,P.t__tilde__):'((6*msig1**2*ynpS1**2 - 24*MT**2*ynpS1**2)*cmath.sqrt(msig1**4 - 4*msig1**2*MT**2))/(16.*cmath.pi*abs(msig1)**3)'})
