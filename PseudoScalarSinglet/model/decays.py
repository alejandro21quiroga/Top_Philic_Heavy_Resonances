...
Decay_PS1 = Decay(name = 'Decay_PS1',
                  particle = P.PS1,
                  partial_widths = {(P.t,P.t__tilde__):'(3*mPS1**2*yPS1**2*cmath.sqrt(mPS1**4 - 4*mPS1**2*MT**2))/(8.*cmath.pi*abs(mPS1)**3)'})
